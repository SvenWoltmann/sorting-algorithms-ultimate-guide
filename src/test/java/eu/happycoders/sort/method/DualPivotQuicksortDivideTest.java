...
public class DualPivotQuicksortDivideTest {
  ...
  public void partitionMIDDLES_randomArray_partitioned() {
    testPartitioning(PivotStrategy.MIDDLES, ArrayUtils::createRandomArray);
  }

  @Test
  public void partitionMIDDLES_sortedArray_partitioned() {
    testPartitioning(PivotStrategy.MIDDLES, ArrayUtils::createSortedArray);
  }

  @Test
  public void partitionMIDDLES_reversedArray_partitioned() {
    testPartitioning(PivotStrategy.MIDDLES, ArrayUtils::createReversedArray);
  }
