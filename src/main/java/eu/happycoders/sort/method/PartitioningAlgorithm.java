...
/**
 * Partitioning algorithm interface; having all Quicksort algorithms implement this interface makes
 * it easier to compare the performance of their partitioning algorithms.
 *
...
public interface PartitioningAlgorithm extends SortAlgorithm {
  ...
  /**
   * Partitions the given elements from the left to the right position and returns the position of
   * the pivot element.
   *
